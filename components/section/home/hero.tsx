...
const InfoContainer: React.FC = () => (
  <div className='pb-8 flex flex-col md:ps-4 ps-0 xl:w-[60%] w-full bg-base_white z-[900] xl:z-[-1] xl:items-start items-center xl:justify-start justify-center'>
    ...
    <Text as='h1' style='font-[600] md:text-[40px] text-[25px] text-deep_purple mb-4 xl:text-start text-center'>
      Connect, Collaborate, Innovate!
    </Text>
    <Text as='h3' style='mb-6 md:text-[20px] text-[14px] xl:text-start text-center'>
    ...
    <Text as='h6' style='mb-[54px] text-[16px] xl:text-start text-center text-purple'>
